...
class ItemServiceImplTest {
    ...
    @Test
    void getItems() {
        List<ItemDto> itemsTest = itemService.getItems(1L, 1, 20);
        ...
        List<ItemDto> items2Test = itemService.getItems(2L, 1, 20);
        ...
        List<ItemDto> items3Test = itemService.getItems(3L, 1, 20);
    ...
    void updateItem() {
        ItemDto itemDto = ItemDto.builder().id(999L)
                .name("Updated").description("Updated").owner(new ItemDto.Owner(user2.getId(), user2.getName(), user2.getEmail())).available(false).build();
    ...
    void searchItem() throws ValidationException {
        ItemDto item11 = itemService.addItem(1L, ItemDto.builder().name("Дрель").description("Дрель эллектрическая").owner(new ItemDto.Owner(user.getId(), user.getName(), user.getEmail()))
                .available(true).build());
        ItemDto item22 = itemService.addItem(1L, ItemDto.builder().name("Дрель ручная").description("Дрель ручная").owner(new ItemDto.Owner(user.getId(), user.getName(), user.getEmail()))
                .available(true).build());
        ItemDto item33 = itemService.addItem(1L, ItemDto.builder().name("Отвертка").description("Отвертка эллектрическая").owner(new ItemDto.Owner(user.getId(), user.getName(), user.getEmail()))
                .available(true).build());
        ItemDto item44 = itemService.addItem(1L, ItemDto.builder().name("Отвертка").description("Отвертка ручная").owner(new ItemDto.Owner(user.getId(), user.getName(), user.getEmail()))
    ...
    @Test
    void addItem() {
        ItemDto testItem = ItemDto.builder().owner(new ItemDto.Owner(user.getId(), user.getName(), user.getEmail()))
        ...
        List<ItemDto> afterItems = itemService.getItems(1L, 1, 20);
        ...
        List<ItemDto> items2Dto = itemService.getItems(2L, 1, 20);
    ...
    @Test
    void addComment() {
        ItemDto itemDto = itemService.getItems(2L, 1, 20).get(0);
