...
class BookingServiceImplTest {
    ...
    void addBooking() throws ValidationException {
        ...
        List<BookingDto> testBookings = bookingService.getAllBookingByState(2L, State.WAITING, 0, 10);
        assertEquals(3, testBookings.size());
        bookingService.addBooking(2L, bookingEntryDto);
        List<BookingDto> testBookings1 = bookingService.getAllBookingByState(2L, State.WAITING, 0, 10);
    ...
    void approveBooking() throws ValidationException {
        ...
        List<BookingDto> testBookingStatusCurrent = bookingService.getAllBookingByState(2L, State.CURRENT, 0, 10);
    ...
    void disApproveBooking() throws ValidationException {
        bookingService.approveBooking(1L, 3L, false);
        List<BookingDto> testBookingStatusRejected = bookingService.getAllBookingByState(2L, State.REJECTED, 0, 10);
    ...
    void getAllBooking_InvalidUser() {
        assertThrows(NotFoundException.class, () -> bookingService.getAllBookingByState(99L, State.WAITING, 0, 10));
    }
    ...
    void getAllBookingByStateAll() throws ValidationException {
        bookingService.approveBooking(1L, 1L, true);
        bookingService.approveBooking(1L, 3L, false);
        List<BookingDto> testBookingStatusAll = bookingService.getAllBookingByState(2L, State.ALL, 0, 10);
    ...
    void getAllBookingByStateAll_invalidUser() {
        assertThrows(NotFoundException.class, () -> bookingService.getAllBookingByState(999L, State.ALL, 0, 10));
    }
    ...
    void getAllOwnerBookingByStateAll() throws ValidationException {
        bookingService.approveBooking(1L, 1L, true);
        bookingService.approveBooking(1L, 3L, false);
        List<BookingDto> testBookingStatusAll = bookingService.getAllOwnersBookingByState(1L, State.ALL, 0, 10);
        assertEquals(3, testBookingStatusAll.size());
        assertEquals(3L, testBookingStatusAll.get(0).getId());
        assertEquals(1L, testBookingStatusAll.get(1).getId());
        assertEquals(2L, testBookingStatusAll.get(2).getId());
    ...
    void getAllOwnerBookingByStateAll_InvalidUser() {
        assertThrows(NotFoundException.class, () -> bookingService.getAllOwnersBookingByState(999L, State.ALL, 0, 10));
    }
    ...
    void getAllBookingByStatePast() throws ValidationException {
        bookingService.approveBooking(1L, 1L, true);
        bookingService.approveBooking(1L, 3L, false);
        List<BookingDto> testBookingStatusPast = bookingService.getAllBookingByState(2L, State.PAST, 0, 10);
    ...
    void getAllBookingByStateFuture() throws ValidationException {
        bookingService.approveBooking(1L, 1L, true);
        bookingService.approveBooking(1L, 3L, false);
        List<BookingDto> testBookingStatusFuture = bookingService.getAllBookingByState(2L, State.FUTURE, 0, 10);
    ...
    void getAllOwnersBookingByStateWaiting() throws ValidationException {
        bookingService.approveBooking(1L, 1L, true);
        bookingService.approveBooking(1L, 3L, false);
        List<BookingDto> testBookings = bookingService.getAllOwnersBookingByState(1L, State.WAITING, 0, 10);
        assertEquals(1, testBookings.size());
    ...
    void getAllOwnersBooking_InvalidUser() {
        assertThrows(NotFoundException.class, () -> bookingService.getAllOwnersBookingByState(99L, State.WAITING, 0, 10));
    }
    ...
    void getAllOwnersBookingByStateRejected() throws ValidationException {
        bookingService.approveBooking(1L, 1L, true);
        bookingService.approveBooking(1L, 3L, false);
        List<BookingDto> testBookingStatusRejected = bookingService.getAllOwnersBookingByState(1L, State.REJECTED, 0, 10);
        assertEquals(1, testBookingStatusRejected.size());
        assertEquals(3L, testBookingStatusRejected.get(0).getId());
    ...
    void getAllOwnersBookingByStateCurrent() throws ValidationException {
        bookingService.approveBooking(1L, 1L, true);
        bookingService.approveBooking(1L, 3L, false);
        List<BookingDto> testBookingStatusCurrent = bookingService.getAllOwnersBookingByState(1L, State.CURRENT, 0, 10);
        assertEquals(1, testBookingStatusCurrent.size());
        assertEquals(1L, testBookingStatusCurrent.get(0).getId());
    ...
    void getAllOwnersBookingByStatePast() throws ValidationException {
        bookingService.approveBooking(1L, 1L, true);
        bookingService.approveBooking(1L, 3L, false);
        List<BookingDto> testBookingStatusPast = bookingService.getAllOwnersBookingByState(1L, State.PAST, 0, 10);
        assertEquals(1, testBookingStatusPast.size());
        assertEquals(2L, testBookingStatusPast.get(0).getId());
    ...
    void getAllOwnersBookingByStateFuture() throws ValidationException {
        bookingService.approveBooking(1L, 1L, true);
        bookingService.approveBooking(1L, 3L, false);
        List<BookingDto> testBookingStatusFuture = bookingService.getAllOwnersBookingByState(1L, State.FUTURE, 0, 10);
        assertEquals(1, testBookingStatusFuture.size());
        assertEquals(3L, testBookingStatusFuture.get(0).getId());
