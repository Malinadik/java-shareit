...
class ItemMapperTest {
    ...
    @Test
    void toItem() {
        ItemDto itemDto = ItemDto.builder().id(1L).name("Test Item").owner(ItemDto.Owner.builder().build()).description("Test item description").available(true).build();
    ...
    void toItemForRequest() {
        Item item = Item.builder().id(1L).owner(User.builder().id(1L).build()).name("Test Item").description("Test item description").available(true).build();
